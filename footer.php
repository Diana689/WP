    ...
    <div class="page-footer__wrapper ">
      <div class="page-footer__cooperation cooperation">
        <div class="page-footer__cooperation-wrapper">
          <b class="cooperation__title"><?php the_field('cooperation-title', 7); ?></b>
          <p class="cooperation__address">
            <span class="cooperation__address-intro"><?php the_field('adress-street', 7); ?></span>            
            <span class="cooperation__address-intro"><?php the_field('address-city', 7 ); ?></span>
          </p>
        </div>
      </div>
      
      <div id="map" class="map js-map"> 
        <?php echo do_shortcode('[yamap center="59.9391,30.3252" height="100%" controls="" zoom="15" type="yandex#map"][yaplacemark  coord="59.938578996944265,30.322818672817533" icon="http://cat-energy/wp-content/uploads/2023/03/map.png"][/yamap]') ?>
      </div>
        ...
        <div class="page-footer__contacts-wrapper">
          ...
          <ul class="social__list">
            <li class="social__item">
              <a class="social__link" href="<?php the_field('Vk-link', 7); ?>">
            ...
            <li class="social__item">
              <a class="social__link" href="<?php the_field('facebook-link', 7); ?>">
          ...
          <div class="copyrigh-wrapper">
            <a class="page-footer__copyright copyright" href="<?php the_field('html-academy-link', 7); ?>">
